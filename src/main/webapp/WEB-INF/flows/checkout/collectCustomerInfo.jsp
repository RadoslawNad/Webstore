	...
	<section class="container">
		<form:form modelAttribute="order.customer" class="formhorizontal">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2 " for="doorNo">House
						number</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2 " for="areaName">City</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2 " for="state">Province</label>
					<div class="col-lg-10">
